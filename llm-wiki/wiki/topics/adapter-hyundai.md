...
학교·전공 검색은 정확 일치 없음, 복수 후보, 시간 초과, 선택 미확인을 값 없는 진단 코드로 전달한다. 시험 선택 뒤 성적란 준비 실패도 구분한다. 기존 유일 결과·코드 확인과 지원 범위는 유지한다. 상세 근거는 [CF-99 승인 결정](../../raw/issues/CF-99/documents/autofill-follow-and-install.md)을 따른다.
