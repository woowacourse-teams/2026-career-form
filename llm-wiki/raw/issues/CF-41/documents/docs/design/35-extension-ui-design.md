...
- 확장 프로그램 전체의 기본 서체는 `Pretendard Variable`이다.
- 폰트는 외부 CDN이나 운영체제 설치 여부에 의존하지 않고 확장 프로그램 산출물에 WOFF2로 포함한다.
- `Pretendard`를 사용할 수 없는 예외 환경에서는 운영체제 기본 sans-serif로 대체한다.
